...
RESOURCES += src/qt/peps.qrc src/qt/peps_locale.qrc

TRANSLATIONS += src/qt/locale/peps_bg.ts \
                src/qt/locale/peps_de.ts \
                src/qt/locale/peps_en.ts \
                src/qt/locale/peps_es.ts \
                src/qt/locale/peps_fi.ts \
                src/qt/locale/peps_fr.ts \
                src/qt/locale/peps_it.ts \
                src/qt/locale/peps_ja.ts \
                src/qt/locale/peps_pl.ts \
                src/qt/locale/peps_pt.ts \
                src/qt/locale/peps_ru.ts \
                src/qt/locale/peps_sk.ts \
                src/qt/locale/peps_sv.ts \
                src/qt/locale/peps_vi.ts \
                src/qt/locale/peps_zh_CN.ts \
                src/qt/locale/peps_zh_TW.ts
