...
// 16262 = 1*5000 + 1*1000 + 1*500 + 1*100 + 1*50 + 1*10 + 1*5 + 1
static const int ZQ_6666 = 16262;
...
enum ZerocoinSpendStatus {
    ZPEPS_SPEND_OKAY = 0,                            // No error
    ZPEPS_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZPEPS_WALLET_LOCKED = 2,                         // Wallet was locked
    ZPEPS_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZPEPS_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZPEPS_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZPEPS_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZPEPS_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZPEPS_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZPEPS_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZPEPS_INVALID_COIN = 10,                         // Selected mint coin is not valid
    ZPEPS_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    ZPEPS_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    ZPEPS_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    ZPEPS_SPENT_USED_ZPEPS = 14                       // Coin has already been spend
};
...
public:
    ...
    */
    ...
    void setZPepsAutoBackups(bool fEnabled)
    {
