...
public:
    ...
    void setZPepsControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzPEPS_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzPEPS_clicked();
    void on_pushButtonZPepsControl_clicked();
