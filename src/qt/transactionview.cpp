                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Peps from zPeps"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zPeps"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zPeps));
