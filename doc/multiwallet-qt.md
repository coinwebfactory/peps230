...
In order to support loading of multiple wallets in peps-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is peps.cpp.
...
Changes to peps.cpp
----------------------
peps.cpp is the entry point into peps-qt, and as such, will require some minor modifications to provide hooks for
